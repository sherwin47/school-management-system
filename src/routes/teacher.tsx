...
import {
  LayoutDashboard, Newspaper, User, ClipboardCheck, BookOpen,
  FileText, BarChart3, MessageSquare, LifeBuoy, CalendarDays, Wallet, Brain,
} from "lucide-react";
...
const groups: NavGroup[] = [
  ...
  { label: "AI Hub", items: [
    { to: "/teacher/ai-hub", label: "AI Tools", icon: Brain },
  ]},
];
