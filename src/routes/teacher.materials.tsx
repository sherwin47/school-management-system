    ...
    <div>
      ...
      <Panel title="Coming up">
        <p className="text-sm text-muted-foreground">
          The detailed UI for <span className="font-medium text-foreground">Study Materials</span>{" "}
          will be built next. The navigation, layout, and design system are ready — we'll flesh out
          the workflows for this section in the next iteration.
        </p>
