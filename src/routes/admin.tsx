...
import {
  ...
  Building2, UserCog, Library, Bus, MessageSquare, BarChart3, Brain,
} from "lucide-react";
...
const groups: NavGroup[] = [
  ...
  { label: "Communications", items: [
    { to: "/admin/communications", label: "SMS · Mail · Notices", icon: MessageSquare },
  ]},
  { label: "AI Hub", items: [
    { to: "/admin/ai-hub", label: "AI Modules", icon: Brain },
  ]},
];
